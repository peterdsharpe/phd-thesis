...
A final consideration that any MDO framework needs to deal with is how to handle units in dimensional quantities. This is a particularly interesting consideration in the context of code transformations, because standard ways of handling units essentially ``box'' all values within a specialized data structure that contains both the numerical value and the unit.
