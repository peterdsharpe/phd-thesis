...
In Figure \ref{fig:benchmark_om_beam}, we compare the wall-clock runtime of AeroSandbox and OpenMDAO as the number of elements $N$ is varied. % TODO continue
...
% OpenAeroStruct, OpenConcept - it's possible
