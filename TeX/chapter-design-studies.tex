...
\begin{example}
    ...
    \begin{itemize}[noitemsep]
        ...
        \item The takeoff lift $L_\text{takeoff}=\frac{1}{2}\rho V_\min^2 C_{L, \max} S$
    ...
    \begin{eqexpl}
        ...
        \item {$V_\min$} $25\ \si{\meter/\second}$, the takeoff airspeed.
        \item {$C_{L, \max}$} $1.6$, the takeoff lift coefficient.
