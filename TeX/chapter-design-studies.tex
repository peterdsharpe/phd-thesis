...
\begin{figure}[h]
    ...
    \caption{Cutout-view of MIT Firefly, showing various unique features. CAD render prepared by Julia Gaubatz.}
...
\begin{example}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item \textbf{Volume accounting / Packaging}: A series of geometric constraints that ensure that the vehicle fits within the specified stowage volume, as well as that the propellant grain fits within the pressure chamber.
        \end{itemize}
...
% TODO detail solution time, etc.

% TODO add XDSM?

\subsection{Results}

The point results of the Firefly design % TODO
...
\begin{table}
    ...
    \begin{tblr}{
        ...
        \toprule
        Component      & Internal Volume [$\rm in^3$] (Percentage) & Mass [gram] (Percentage of all-up) & $x_g$ of CG [mm] \\
        \midrule
        Fuel (all-up)  & 38.8 (54.2\%)                             & 1019 (42.7\%)                      & 321              \\
        ...
        Tails          & -                                         & 70 (2.9\%)                         & 436              \\
        \midrule
        Total (all-up) & 71.5 (100\%)                              & 2389 (100\%)                       & 248              \\
        Total (empty)  & 71.5 (100\%)                              & 1370 (57.3\%)                      & 195              \\
        \bottomrule
    \end{tblr}
\end{table}
