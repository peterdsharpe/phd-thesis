...
\section{MIT Dawn (Electra.aero SACOS) Solar-Electric HALE Aircraft} % TODO name
\label{sec:dawn}
...
\begin{example}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item The vehicle design itself, which includes:
            \begin{itemize}
                \item Geometric shape variables, with similar parameterization methodology as the Firefly MDO setup of Section \ref{sec:firefly-mdo}.
