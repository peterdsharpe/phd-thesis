...
A category of design optimization problems that code transformations are particularly well-suited for are combined vehicle-and-trajectory optimization problems, as shown in several studies in Chapter \ref{chap:design-studies}.
